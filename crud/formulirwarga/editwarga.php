...
$warga = query("SELECT * FROM warga WHERE nik=$nik")[0];
...
<h1 align="center">Edit Tabel Pada Kolom <?= $warga["nama_warga"]?>  </h1>

<form action="" method="POST"> 
  <div class="form-group">
    
    <label for="nama_warga">Nama Warga</label>
    <input  type="text" class="form-control"  name="nama_warga" id="nama_warga" placeholder="Nama Warga" value="<?= $warga["nama_warga"]?>">
  </div>

   <div class="form-group">
    <label  for="nik">NIK Tidak Dapat Dirubah : <b><?= $warga["nik"]?></b></label>
    <input  hidden type="text" class="form-control"  name="nik" id="nik" placeholder="NIK" value="<?= $warga["nik"]?>">
  </div>

   <div class="form-group">
    <label  for="ttl">Tempat Tanggal Lahir</label>
    <input  type="text" class="form-control"  name="ttl" id="ttl" placeholder="Tempat Tanggal Lahir" value="<?= $warga["ttl"]?>">
  </div>

  <div class="form-group">
    <label  for="alamat">Alamat</label>
    <input  type="text" class="form-control"  name="alamat" id="alamat" placeholder="Alamat " value="<?= $warga["alamat"]?>">
  </div>

  <div class="form-group">
    <label  for="kode_pos">Kode Pos</label>
    <input  type="text" class="form-control"  name="kode_pos" id="kode_pos" placeholder="Kode Pos" value="<?= $warga["kode_pos"]?>">
  </div>

  <div class="form-group">
    <label  for="kode_kota">Kode Kota</label>
    <input  type="text" class="form-control"  name="kode_kota" id="kode_kota" placeholder="Kode Kota" value="<?= $warga["kode_kota"]?>">
  </div>
