...
<?php foreach ($kota as $row) :  ?>
  <tbody>
    <tr align="center">
      ...
      <td><?= $row ["nama_kota"]; ?></td>
      <td> <?= $row ["kode_kota"]; ?></td>
      <td><a href="editkota.php?kode_kota=<?= $row ["kode_kota"]; ?>"> Edit </a></td>
      <td><a href="hapus.php?kode_kota=<?= $row ["kode_kota"];?>" onclick="return confirm ('yakin?')"> Hapus</a></td>
    </tr>
<?php $a++; ?>
<?php endforeach ; ?>
