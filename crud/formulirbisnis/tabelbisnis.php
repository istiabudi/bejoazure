...
$bisnis = query ("SELECT * FROM bisnis");
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item active" href="tabelbisnis.php">Tabel Bisnis</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="formulirbisnis.php">Formulir Bisnis</a>
...
<h1 align="center">Tabel Bisnis </h1>
...
<?php foreach ($bisnis as $row) :  ?>
  <tbody>
    <tr align="center">
      ...
      <td><?= $row ["kode_pos"];?></td>
      <td><?= $row ["kode_kota"]?></td>
      <td><a href="editbisnis.php?id_bisnis=<?= $row ["id_bisnis"]; ?>"> Edit </a></td>
      <td><a href="hapus.php?id_bisnis=<?= $row ["id_bisnis"];?>" onclick="return confirm ('yakin?')"> Hapus</a></td>
    </tr>
<?php $a++; ?>
<?php endforeach ; ?>
