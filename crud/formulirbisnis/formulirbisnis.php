<?php
    ...
    if (isset ($_POST['submit'])){   
        if (tambah ($_POST)> 0){
            ...
            document.location.href= 'formulirbisnis.php';
            </script>
            ";
        } else {
            echo "<script> 
...
<h1 align="center">Formulir Bisnis</h1>

<form action="" method="POST"> 
  <div class="form-group">
    
    <label for="nama_bisnis">Nama Bisnis</label>
    <input  type="text" class="form-control"  name="nama_bisnis" id="nama_bisnis" placeholder="Nama Bisnis" Required>
  </div>

   <div class="form-group">
    <label  for="jenis_bisnis">Jenis Bisnis</label>
    <input  type="text" class="form-control"  name="jenis_bisnis" id="jenis_bisnis" placeholder="Jenis Bisnis" Required>
  </div>

   <div class="form-group">
    <label  for="id_bisnis">ID Bisnis</label>
    <input  type="text" class="form-control"  name="id_bisnis" id="id_bisnis" placeholder="Id Bisnis" Required>
  </div>
  ...
  <div class="form-group">
    ...
    <input  type="text" class="form-control"  name="kode_kota" id="kode_kota" placeholder="Kode Kota" Required>
  </div>
