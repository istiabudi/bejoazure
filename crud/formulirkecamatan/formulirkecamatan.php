<?php
    ...
    if (isset ($_POST['submit'])){   
        if (tambah ($_POST)> 0){
            ...
            document.location.href= 'formulirkecamatan.php';
            </script>
            ";
        } else {
            echo "<script> 
...
<h1 align="center">Formulir Kecamatan </h1>

<form action="" method="POST"> 
  <div class="form-group">
    
    <label for="nama_kecamatan">Nama Kecamatan</label>
    <input  type="text" class="form-control"  name="nama_kecamatan" id="nama_kecamatan" placeholder="Nama Kecamatan" Required>
  </div>

  <div class="form-group">
    <label  hidden for="kode_pos">Kode Pos</label>
    <input  hidden type="text" class="form-control"  name="kode_pos" id="kode_pos" placeholder="Kode Pos">
  </div>
